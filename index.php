...
$test = new Services_WTF_Test("mailadresiniz@gmail.com", "API_KEY"); // ilk alana GTmetrixe kayıt olduğunuz mail adresini, ikinci alana size verdiği api key'i girin
...
$url_to_test = "https://site.com/"; //taranacak site adresi
echo "Testing ".$url_to_test."<br>";
$testid = $test->test(array(
    'url' => $url_to_test, //site url adresi gönderildi
    'location' => 2, // konum seçeneği gönderildi, en altta konumların id'si yazmaktadır
    'x-metrix-adblock' => 1 // adblock kullanılarak tarama yapılması belirtildi, kullanılmasın istiyorsanız 0 yapabilir ya da silebilirsiniz
));
if ($testid) {
